...
g2_a_z_c2 <- function(a_value, z_value, c2_value) {
  pz_given_c1_c2_a(
    z_value = z_value, c1_value = 0, c2_value = c2_value,
    a_value = a_value
  ) *
    pa_given_c1_c2(a_value = a_value, c1_value = 0, c2_value = c2_value) *
    pc1(0) +
    pz_given_c1_c2_a(
      z_value = z_value, c1_value = 1, c2_value = c2_value,
      a_value = a_value
    ) *
...
g5_y_a_z_c2_c3 <- function(y_value, a_value, z_value, c2_value, c3_value) {
  py_given_c1_c2_c3_a_z(
    y_value = y_value, c1_value = 0,
